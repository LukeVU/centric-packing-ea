...
## TODO: add a feature that will move a poly to the center if it is completely outside the field
...
def randomize_shape_location_rotation(poly: Poly, field_diameter: int) -> Poly:
    ...
    new_poly = affinity.translate(poly, new_center[0] - current_center.x, new_center[1] - current_center.y)
    new_poly = affinity.rotate(new_poly, rotation)
