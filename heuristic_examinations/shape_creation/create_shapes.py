...
from ..polys_classes.poly import Poly
from ..polys_classes.poly_group import PolyGroup

def easy_poly_gen(number_of_polys: int, field_diameter: int, size: float, 
                    irregularity: float, spikiness: float,
                    num_vertices: int) -> PolyGroup:
    """
    ...
    for i in range(number_of_polys):
        ...
        # Create the polygon
        polygons.append(Poly(Polygon(generate_polygon(center, size,
                                                 irregularity, spikiness,
                                                 num_vertices))))

    return PolyGroup(polygons)
