...
file_location = "heuristic_examinations\\results\\eas_['EAMutateCloser']_500_generations_15_runs_5_polys_10_survivors_40_children___2023_5_22_0_51.pkl"
with open(file_location, "rb") as f:
    complete_ea_runs = pickle.load(f)

# plot the first and last generations of each run
for complete_run in complete_ea_runs[0]:
